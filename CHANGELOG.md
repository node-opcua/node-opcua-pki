...
## [6.22.1](https://github.com/node-opcua/node-opcua-pki/compare/v6.22.0...v6.22.1) (2026-09-18)

Security backport onto the CommonJS 6.x line: both certificate-store hardening
fixes, without the ESM-only build or the node-opcua-crypto 6 bump that ship in
7.0.0. Consumers that cannot yet move to the ESM-only 7.0.0 should upgrade to
this release.

### Bug Fixes

* **security:** contain certificate store writes to prevent CN path traversal (GHSA-m7pm-7jm9-cfp4) ([f892108](https://github.com/node-opcua/node-opcua-pki/commit/f892108162e4d016d01490a9a537fc759eb9056d))
* **security:** reject best-fit-unsafe characters in openssl arguments (GHSA-65c3-pff5-j8cp) ([a871ca4](https://github.com/node-opcua/node-opcua-pki/commit/a871ca494af8871ef42dad3de7a38b7c1de0508c))
...
* **test:** stop the suite hanging after it passes ([50713da](https://github.com/node-opcua/node-opcua-pki/commit/50713dac45411845d1f274d4a1c11d193d288b5c))
...
* skip flaky live-detection tests on macOS ([dd2242e](https://github.com/node-opcua/node-opcua-pki/commit/dd2242e9c41e12e8bb2e9d9e31304ef0a90da4ba))
...
* **ci:** fix publish workflow skipping on tag push ([4c59b2a](https://github.com/node-opcua/node-opcua-pki/commit/4c59b2af0fc7586eb30fe942cf79f5b44906cd83))
...
#### [5.7.0](https://github.com/node-opcua/node-opcua-pki/compare/5.6.0...5.7.0)

- chore: downgrade chokidar to version 4 [`3333e72`](https://github.com/node-opcua/node-opcua-pki/commit/3333e724b561edf8d934a2e5c13f11304c0a0aec)

#### [5.6.0](https://github.com/node-opcua/node-opcua-pki/compare/5.5.0...5.6.0)

> 15 December 2025

- update packages [`b9dfcad`](https://github.com/node-opcua/node-opcua-pki/commit/b9dfcad8b3aef9ef5e54bb5c4f6696940e1f352b)
- add prepublish script [`297a7ac`](https://github.com/node-opcua/node-opcua-pki/commit/297a7acb8e84ae1403c49bae6849123e98718b23)
- chore: release v5.6.0 [`6193bf8`](https://github.com/node-opcua/node-opcua-pki/commit/6193bf8245c08674bb59eaa6b9c85c68bc154c56)
...
- chore: release v5.5.0 [`4b5d9ea`](https://github.com/node-opcua/node-opcua-pki/commit/4b5d9ea4d22f390783d0f60823dd44bf055429a5)
